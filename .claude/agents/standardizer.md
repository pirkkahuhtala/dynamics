...
**If in doubt, do NOT proceed.** Moving to Clear is a high-commitment decision. Recommend cycling back via `/assess`.
...
If any of these appear → recommend `/assess` to re-evaluate domain placement.
